...
with open("decoder-probability-thresh/data.json", "r") as file:
...
fig1.tight_layout()
fig1.savefig('decoder-probability-thresh/distributions_overlay.png', dpi=150)
...
fig2.tight_layout()
fig2.savefig('decoder-probability-thresh/distributions_cdf.png', dpi=150)
...
fig3.tight_layout()
fig3.savefig('decoder-probability-thresh/distributions_log.png', dpi=150)
...
fig4.tight_layout()
fig4.savefig('decoder-probability-thresh/scatter_ppl_rank.png', dpi=150)
...
fig5.tight_layout()
fig5.savefig('decoder-probability-thresh/scatter_highprob_rank.png', dpi=150)
